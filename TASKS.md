...
- [x] Install Core Dependencies (`langchain`, `fastapi`, `pymilvus`, `google-genai`)
...
- [x] **API Migration (FastAPI)**
  - [x] Install `fastapi`, `uvicorn`.
  - [x] Create `src/api` module.
  - [x] Expose RAG engine via REST API (`POST /chat`).
- [ ] **Persistent Memory**
